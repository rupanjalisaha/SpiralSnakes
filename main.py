...
async def nextlevel(score):
    ...
    obs_x = random.randint(100,window_width-50)
    obs_y = random.randint(100,window_height-30)
    obs_size = 20
    obstacle1_x = window_width-80
    obstacle1_y = 450
    obstacle2_x = 80
    obstacle2_y = 50
    obstacle3_x = 80
    obstacle3_y = 450
    obstacle4_x = window_width-80
    obstacle4_y = 50
    obstacle_size = 25
    food_radius = 6
    fps = 40
...
#Game Loop
    while exit_game !=True:
        if game_over == True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_RETURN:
                        welcome()
            if new_score<650:
                game_score("Enjoyed the game!", red, 150, 270)
            else:
                game_score("You're a senior player. No!", red, 150, 350)
        else:
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    exit_game = True
            ...
            snake_y +=velocity_y
            if obstacle1_x<0:
                obstacle1_x =window_width
                obstacle1_y -=5
            if obstacle2_x > window_width:
                obstacle2_x =0
                obstacle2_y +=5
            if obstacle3_x > window_width:
                obstacle3_x =0
                obstacle3_y -=5
            if obstacle4_x <0:
                obstacle4_x =window_width
                obstacle4_y +=5
            if obstacle1_y<0:
                obstacle1_x -=5
                obstacle1_y =window_height
            if obstacle2_y > window_height:
                obstacle2_x +=5
                obstacle2_y =0
            if obstacle3_y <0:
                obstacle3_x +=5
                obstacle3_y =window_height
            if obstacle4_y > window_height:
                obstacle4_x -=5
                obstacle4_y =0
            if abs(snake_x - food_x)<10 and abs(snake_y - food_y)<10:
                ...
                obs_x = random.randint(100,window_width-50)
                obs_y = random.randint(100,window_height-10)
                snake_length +=2
                if new_score > 1000:
            ...
            warning("*Be careful from the red and blue squares", red, 50, window_height-100)
            screen_text("Score above 1000 to reach the final level", red, 150, 550)
            if abs(food_x - obstacle1_x)>25 and abs(food_y-obstacle1_y)>25 or abs(food_x-obstacle2_x)>25 and abs(food_y-obstacle2_y)>25 or abs(food_x - obstacle3_x)>25 and abs(food_y-obstacle3_y)>25 or abs(food_x-obstacle4_x)>25 and abs(food_y-obstacle4_y)>25:
                pygame.draw.circle(gameWindow,golden,[food_x,food_y],food_radius)
...
thirdlevel(new_score):
    ...
    while exit_game != True:
        ...
        pygame.display.update()
        clock.tick(60)
async def finallevel(new_score):
    exit_game = False
    snake_x = 440
    snake_y = 0
    snake_size = 12
    food_1_x = random.randint(30,window_width-50)
    food_1_y = random.randint(30,window_height-20)
    food_2_x = random.randint(50,window_width-30)
    food_2_y = random.randint(50,window_height-20)
    obs1_x = random.randint(50,window_width-30)
    obs1_y = random.randint(50,window_height-20)
    obs2_x = random.randint(250,window_width)
    obs2_y = random.randint(250,window_height)
    food_radius = 5
    obs_size = 40
    obstacle1_x = window_width-80
    obstacle1_y = window_height-50
    obstacle2_x = 80
    obstacle2_y = 50
    obstacle3_x = 80
    obstacle3_y = window_height-50
    obstacle4_x = window_width-80
    obstacle4_y = 50
    obstacle_size = 25
    fps = 40
...
#Game Loop
    while exit_game !=True:
        if game_over == True:
            ...
            warning("*Be careful from the squares", red, 50, window_height-50)
            ...
            if abs(snake_x - food_1_x)<5 and abs(snake_y - food_1_y)<5:
                final_score +=5
                food_1_x = random.randint(30,window_width-20)
                food_1_y = random.randint(30,window_height-20)
                obs1_x = random.randint(100,window_width-20)
                obs1_y = random.randint(100,window_height-20)
                snake_length +=5
            if abs(snake_x - food_2_x)<7 and abs(snake_y - food_2_y)<7:
                final_score +=10
                food_2_x = random.randint(50,window_width-20)
                food_2_y = random.randint(50,window_height-20)
                obs2_x = random.randint(250,window_width)
                obs2_y = random.randint(250,window_height)
                snake_length +=3
            ...
            screen_text("Level:2", blue, 270, 10)
            warning("Be careful from the squares!", red, 150, window_height-50)
            if abs(food_1_x - obstacle1_x)>20 and abs(food_1_y-obstacle1_y)>20 or abs(food_1_x-obstacle2_x)>20 and abs(food_1_y-obstacle2_y)>20 or abs(food_1_x - obstacle3_x)>20 and abs(food_1_y-obstacle3_y)>20 or abs(food_1_x-obstacle4_x)>20 and abs(food_1_y-obstacle4_y)>20 or food_1_x!=food_2_x and food_1_y!=food_2_y:
                pygame.draw.circle(gameWindow,white,[food_1_x,food_1_y],food_radius,5)
...
async def gameloop():
    ...
    obstacle_size2 = 20
    obstacle_x3 = 350
    obstacle_y3 = random.randint(0,window_height)
    obstacle_size3 = 30
    obstacle_x4 = window_width
    obstacle_y4 = 5
    obstacle_size4 = 20
    #body_parts = 3
    food_x = random.randint(30,window_width-50)
    food_y = random.randint(30,window_height-20)
    obs_x = random.randint(100,window_width-50)
    obs_y = random.randint(100,window_height-20)
    obs_size = 25
    food_radius = 4
    fps = 30
    velocity_x = 6
        ...
        if game_over == True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    obstacle_x4 -=init_velocity_2
                    obstacle_y4 -=init_velocity_2
                    if event.key == pygame.K_RIGHT:
                        velocity_x = init_velocity
                        velocity_y = 0
                    if event.key == pygame.K_DOWN:
            ...
            if obstacle_x2 >= window_width:
                obstacle_y2+=50
                obstacle_x2 = 0
            if obstacle_x1 >= window_width:
                obstacle_y1 +=50
                obstacle_x1 =0
            if obstacle_y2 >= window_height:
                obstacle_y2 =0
                obstacle_x2 +=50
            if abs(snake_x - food_x)<5 and abs(snake_y - food_y)<5:
                score +=10
                food_x = random.randint(30, window_width-30)
                food_y = random.randint(30, window_height-50)
                obstacle_x3 = 250
                obstacle_y3 = random.randint(300,window_height)
                snake_length +=2
                if score > 300:
                  obstacle_x3 = random.randint(300,window_width)
                  obstacle_y3 = 300
                if score>500:
                   secondlevel(score)
            ...
            warning("Be careful from the squares!", red, 150, window_height-75)
            ImportWarning
            pygame.draw.circle(gameWindow,red,[food_x,food_y],food_radius,5)
            ...
            if abs(obstacle_x3-food_x)>30 and abs(obstacle_y3-food_y)>30:
               pygame.draw.rect(gameWindow,black,[obstacle_x3,obstacle_y3,obstacle_size3,obstacle_size3])
            head = []
            head.append(snake_x)
            head.append(snake_y)
            snake_list.append(head)
            ...
            if abs(snake_x - obstacle_x2)<15 and abs(snake_y - obstacle_y2)<15:
                ...
                warning("Oh no! Crashed! Game Over",red,250,200)
                game_over = True
            if abs(snake_x - obstacle_x3)<25 and abs(snake_y - obstacle_y3)<25:
                pygame.mixer.music.load('collision.wav')
                pygame.mixer.music.play()
                warning("Oh no! Crashed! Game Over",red,250,200)
                game_over = True
            if abs(snake_x - obstacle_x4)<20 and abs(snake_y - obstacle_y4)<20:
                pygame.mixer.music.load('collision.wav')
                pygame.mixer.music.play()
                warning("Oh no! Crashed! Game Over",red,250,200)
                game_over = True
    ...
    quit()
asyncio.run(welcome())
asyncio.run(firstlevel())
asyncio.run(gameloop())
asyncio.run(secondlevel())
asyncio.run(nextlevel())